  ...
  <div class="row" style="margin-top:20px;">
    ...
    <div class="col-md-6" style="margin-left:20px;margin-right:20px;margin-bottom:3px;">
       ...
       <div class="row"style="height:100px;background-color:white;margin-bottom:3px;">
           ...
           <div class="col-md-3"><a href="/Myspring/confirm?id=<c:out value="${listValue.getID()}"/>" style="color:grey;">Confirm</a><span class="glyphicons glyphicons-user-add"></span></div>
           <div class="col-md-3"><a href="/Myspring/delete?id=<c:out value="${listValue.getID()}"/>" style="color:grey;">Delete request</a><span class="glyphicons glyphicons-user-add"></span></div>
       </div>
       </c:forEach> 
    </div>
   <div class="col-md-3"style="background-color:white;height:300px;">Trending</div>
  </div>
</div>
