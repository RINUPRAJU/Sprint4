...
<div class="container-fluid"style="background-color:#f7f7f7">
  <div class="row" style="margin-top:20px;">
    <div class="col-md-2"><img height="40",width="40"src="<c:url value="/images/${file}" />"/> ${firstname} ${lastname} <br>
     ...
     <span class="glyphicon glyphicon-edit"style="color:blue;"></span><a href="friendrequest">Approve Friend</a><br></div>
      <div class="col-md-6" style="margin-left:20px;margin-right:20px;margin-bottom:3px;">
       ...
       <div class="row"style="height:100px;background-color:white;margin-bottom:3px;">
           ...
           <div class="col-md-4"><a href="/Myspring/unfriend?id=<c:out value="${listValue.getID()}"/>" style="color:grey;">Unfriend</a><span class="glyphicons glyphicons-user-add"></span></div>
